...
class DropdownFormField<T> extends StatefulWidget {
  ...
  // final void Function(T item)? validator;
...
class DropdownFormFieldState<T> extends State<DropdownFormField>
  ...
  void initState() {
    ...
    if(widget.initialValue!=null && widget.initialValue!.isNotEmpty) {
      _selectedItem = {"${widget.title}": "${widget.initialValue}"} as T?;
      _displayItem = widget.displayItemFn(_selectedItem);
    }


    widget.textController.addListener(() {
      print("test listenere ${widget.textController}");
            ...
            child: Container(
              ...
              child: FormField(
                ...
                validator: (s) {
                  ...
                  print("validator ${_effectiveController!.value} s:$s");
                    ...
                    child: this._overlayEntry != null
                      ...
                      child: EditableText(
                        ...
                        onSubmitted: (str) {
                          ...
                          widget.textController.value=_searchTextController.value =
                              TextEditingValue(text: "");
                          setState(() {
                            // _widgetFocusNode.requestFocus();
                            _removeOverlay();
  ...
  void _animateToIndex(int index,int itemCount) {
...
// Scroll to that position.
  ...
  _onKeyPressed(RawKeyEvent event) {
    ...
    if (event.isKeyPressed(LogicalKeyboardKey.enter)) {
      ...
      _animateToIndex(_listItemFocusedPosition,_options!.length);
      return true;

...
class RatingCommonWidget extends StatefulWidget {
  /// Creates [RatingBar] using the [ratingWidget].
  const RatingCommonWidget({
  ...
  const RatingCommonWidget.builder({
  ...
  @override
  _RatingCommonWidgetState createState() => _RatingCommonWidgetState();
}

class _RatingCommonWidgetState extends State<RatingCommonWidget> {
  double _rating = 0.0;
  bool _isRTL = false;
  ...
  @override
  void didUpdateWidget(RatingCommonWidget oldWidget) {
